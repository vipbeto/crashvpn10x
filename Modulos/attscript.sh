...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://raw.githubusercontent.com/vipbeto/crashvpn10x/main/versao
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget https://raw.githubusercontent.com/vipbeto/crashvpn10x/main/crashvpn > /dev/null 2>&1
